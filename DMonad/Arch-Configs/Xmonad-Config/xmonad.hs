...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
  ...
  [ ((modMask, xK_e), spawn $ "rofi -show window" )
  , ((modMask, xK_c), spawn $ "ty" )
  , ((modMask, xK_f), sendMessage $ Toggle NBFULL)
  , ((modMask, xK_h), spawn $ "urxvt -e htop" )
  , ((modMask, xK_m), spawn $ "urxvt -e mocp" )
  , ((modMask, xK_x), kill )
  ...
  , ((modMask, xK_d), spawn $ "dmenu_recency -h 30 -l 9 -b -p Robin::chandra@robin: -o 65 -w 1352 -x 7 -y 7 -o 0.9" )
